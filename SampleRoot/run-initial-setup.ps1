...
& "$ScriptPath\_RobustHaven.DevOps\tools\psake.4.2.0.1\tools\psake.ps1" -buildFile "$ScriptPath\_RobustHaven.DevOps\Build.ps1" -taskList RunInitialSetup -properties @{  }
